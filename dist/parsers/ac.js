...
exports.getAC = exports.ARMOR_TYPE_SHIELD = exports.ARMOR_TYPE_HEAVY = exports.ARMOR_TYPE_MEDIUM = exports.ARMOR_TYPE_LIGHT = void 0;
...
var getAC = function (character) {
    ...
    if (equippedArmor.length > 0) {
        ...
        armorAc = Math.max.apply(Math, unarmoredModifiers.map(function (modifier) {
            var ac = characterAc;
            if (modifier.statId) {
                var validId = (0, converter_1.convertBeyondStatIdToAbility)(modifier.statId);
                if (validId) {
